...
Route::get('aduans/file/{id}', [App\Http\Controllers\AduanController::class,'download'])->name('aduans.download');
Route::get('aduans/verif/{id}', [App\Http\Controllers\AduanController::class,'verif'])->name('aduans.verif');